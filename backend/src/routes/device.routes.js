...
import { getDeviceReadings } from "../controllers/reading.controller.js";
...
deviceRouter.get("/:deviceId/readings", authenticateToken, authorizeRoles("farmer", "agronomist", "admin"), getDeviceReadings);
